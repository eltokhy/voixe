...
public struct RecordingDecisionEngine {
    ...
    /// See `VoixeCoreConstants.modifierOnlyMinimumDuration` for rationale.
    public static let modifierOnlyMinimumDuration: TimeInterval = VoixeCoreConstants.modifierOnlyMinimumDuration
