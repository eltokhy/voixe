...
/// Shared helper for creating consistent os.Logger instances across the Hex app and VoixeCore.
public enum VoixeLog {
  public static let subsystem = "com.enginecy.voixe"
  ...
  public static let refine = logger(.refine)
}
