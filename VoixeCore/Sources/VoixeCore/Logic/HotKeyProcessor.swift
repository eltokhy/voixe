...
private let hotKeyLogger = VoixeLog.hotKey
...
public struct HotKeyProcessor {
    ...
    public static let doubleTapThreshold: TimeInterval = VoixeCoreConstants.doubleTapWindow
    ...
    public static let pressAndHoldCancelThreshold: TimeInterval = VoixeCoreConstants.pressAndHoldCancelWindow
    ...
    public init(
        ...
        minimumKeyTime: TimeInterval = VoixeCoreConstants.defaultMinimumKeyTime
    ) {
        self.hotkey = hotkey
