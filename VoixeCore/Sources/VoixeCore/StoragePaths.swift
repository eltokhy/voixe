...
public extension URL {
	static var hexApplicationSupport: URL {
		get throws {
			...
			let hexDirectory = appSupport.appendingPathComponent("com.enginecy.voixe", isDirectory: true)
	...
	static var hexRefineModelsDirectory: URL {
		get throws {
			let directory = try hexApplicationSupport.appendingPathComponent("refine-models", isDirectory: true)
