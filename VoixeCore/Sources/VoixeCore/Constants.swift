...
/// Central repository for timing thresholds and magic numbers used throughout VoixeCore.
///
...
public enum VoixeCoreConstants {
    ...
    ///
    /// **Used in:**
    /// - `VoixeSettings`: Default value for user preference
    ...
    ///
    /// **Used in:**
    /// - `VoixeSettings`: Default sound effects volume
